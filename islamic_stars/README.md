The logic for this sketch was developed using JRubyArt because it supports loading of SVG file and in general ruby leads to dry coding practices unlike java and javascript, here is the JRubyArt code:-
```ruby
